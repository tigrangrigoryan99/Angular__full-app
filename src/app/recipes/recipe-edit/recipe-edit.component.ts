...
export class RecipeEditComponent implements OnInit {
  ...
  onSubmit() {
    // const recValue = this.recipeForm.value;
    // const newRecipe = new Recipe(
    //   recValue['name'],
    //   recValue['description'],
    //   recValue?.imagePath,
    //   recValue['ingredients']
    // );

    // Karox enq stexcelu poxaren miangamic dnel 'this.recipeForm.value'
    // qani vor entexela mer grac structura-i devov sax drvac.
